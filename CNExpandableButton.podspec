Pod::Spec.new do |s|
	...
	s.summary = "CNExpandableButton is a class designed to be used like an expandable UIButton; as seen in the iOS Camera app for the flash button. Based on CNExpandableButton."
